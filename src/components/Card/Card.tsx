...
function Card({img,name,category,price,id}:ClothList) {
  const navigToDetail = useRouter();
  return (
    <div onClick={() => navigToDetail.push(`/${category}/${id}`)}  className='cursor-pointer py-10 flex flex-col items-start max-[860px]:py-5 max-[360px]:py-2'>
      <Image
      ...
      <div className='font-bold max-[1080px]:text-sm '>
        <h4 className=' max-[960px]:text-[13px] max-[890px]:text-[12px] max-[820px]:text-[11px] max-[760px]:text-[10px] max-[700px]:text-[9px] max-[630px]:text-[12px] max-[500px]:text-[11px] max-[480px]:text-[10px] max-[440px]:text-[9px] max-[400px]:w-[180px] max-[380px]:w-[160px] max-[360px]:w-[140px] max-[300px]:w-[250px]'>{name}</h4>
      </div>
    </div>
  );
};
