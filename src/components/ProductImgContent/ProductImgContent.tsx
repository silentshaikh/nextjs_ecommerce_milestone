...
short sleeves. Button-up front.
    ...
    <h4 className='font-bold'>Color:</h4>
        ...
        {prod && <button onClick={() => onAddToCart(prod,prod.productquantity)} className='uppercase bg-[#D9D9D9] mt-3 py-2 max-[380px]:w-[250px] max-[300px]:w-[220px]'>add to cart</button>}
    </div>
  )
};
